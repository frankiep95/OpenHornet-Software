 ...
 ********************************************************************************************************************/
const int RC2_ALL_PANELS_LED_COUNT = 344;  // Total number of LEDs in all panels
const Led rc2AllPanelsLedTable[RC2_ALL_PANELS_LED_COUNT] PROGMEM = {
    ...
    {260, LED_CONSOLE_BL}, {261, LED_CONSOLE_BL}, {262, LED_CONSOLE_BL},
    
    // KY58 Panel (79 LEDs) 
    {263, LED_CONSOLE_BL}, {264, LED_CONSOLE_BL}, {265, LED_CONSOLE_BL}, {266, LED_CONSOLE_BL}, {267, LED_CONSOLE_BL}, 
    {268, LED_CONSOLE_BL}, {269, LED_CONSOLE_BL},
    ...
    {340, LED_CONSOLE_BL}, {341, LED_CONSOLE_BL}, {342, LED_CONSOLE_BL}
};
